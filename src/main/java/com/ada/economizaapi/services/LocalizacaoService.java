...
public class LocalizacaoService {
    ...
    public Double retornarDistanciaKm(String localizacaoOrigem, String localizacaoDestino) {
        ...
        return WebClient.builder().clientConnector(connector)
                ...
                .uri(uriBuilder -> uriBuilder
                        ...
                        .queryParam("start", localizacaoOrigem)
                        .queryParam("end", localizacaoDestino)
                        .build())
                .retrieve()
